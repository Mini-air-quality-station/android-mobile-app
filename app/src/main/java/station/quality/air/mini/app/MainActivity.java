...
public class MainActivity extends AppCompatActivity implements
    ...
    public static final String SAVE_FILENAME = "mini_air_quality_data.csv";
    private WebView webView_config;
    private DrawerLayout drawerLayout;
    private String curr_url;
    private static final String ipAddress = "192.168.88.1";
    private static final String GRAFANA_URL = "http://" + ipAddress + ":3000";
    private static final String HOMEPAGE_URL = "http://" + ipAddress;
    private static final String CONFIGURATION_URL = "http://" + ipAddress + "/configuration.php";
    private static final String ABOUT_URL = "http://" + ipAddress + "/about.php";
